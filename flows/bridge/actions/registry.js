...
const BRIDGE_ACTIONS = {
  ...
  scrapeNosposStockMovements: handleBridgeAction_scrapeNosposStockMovements,
  ...
  scrapeNosposAgreements: handleBridgeAction_scrapeNosposAgreements,
  scrapeNosposCarts: handleBridgeAction_scrapeNosposCarts,
  scrapeNosposTradingReport: handleBridgeAction_scrapeNosposTradingReport,
  ...
  appendUploadLog: handleBridgeAction_appendUploadLog,
  checkNosposCustomerBuyingSession: handleBridgeAction_checkNosposCustomerBuyingSession,
  checkNosposLoginAndShop: handleBridgeAction_checkNosposLoginAndShop,
